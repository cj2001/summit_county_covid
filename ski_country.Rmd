---
title: "Colorado Ski County COVID-19 Dashboard. Last updated 2020-07-29."
output: 
...
full_counties <- union(temp4, eagle)
...
last_30 <- full_counties %>% filter(date > as.Date("2020-06-29"))
...
```{r}
full_counties_eagle <- full_counties %>% filter(county=="Eagle")
ggplotly(
...
```{r}
full_counties_summit <- full_counties %>% filter(county=="Summit")
ggplotly(
